...
describe("OpenWeatherMap", () => {
  ...
  describe('currentConditions', () => {
    ...
    it('returns a single object with correct keys', () => {
      ...
      expect(data).to.have.property('rain', testData.list[0].rain['3h']);
    });
  });
  ...
  describe('hourly', () => {
    ...
    it('returns an object with correct deep fields', () => {
      ...
      expect(data[Object.keys(data)[0]][0]).to.have.deep.property('rain');
    });
  });
  ...
  describe('daily', () => {
    ...
    it('object has correct fields', () => {
      ...
      expect(data[Object.keys(data)[0]]).to.have.deep.property('rain');
    });
  });
});
